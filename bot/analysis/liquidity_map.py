...
from bot.utils.session_clock import ASIAN_SESSION
...
def build_liquidity_map(symbol: str, silent: bool = False) -> dict[str, object]:
    ...
    structure_df = datasets.get((symbol, "H1"))
    intraday_df = datasets.get((symbol, "M15"))
    daily_df = datasets.get((symbol, "D1"))
    weekly_df = datasets.get((symbol, "W1"))
